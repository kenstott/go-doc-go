#!/usr/bin/env python3
"""Isolated Go test with dedicated output directory."""
...
# Clean setup
os.system("rm -rf tests/test_output/go_clean")
os.system("mkdir -p tests/test_output/go_clean")

print("=== GO MODULES TEST (CLEAN) ===")
