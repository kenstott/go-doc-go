...
class PostgreSQLDocumentDatabase(DocumentDatabase):
                ...
                if self.store_full_text:
                    self.cursor.execute(
                        ...
                        (element_id, doc_id, element_type, parent_id, content_preview, 
                         content_location, content_hash, metadata, element_order, document_position, full_content)
    ...
    def _create_tables(self) -> None:
        ...
        try:
            ...
            # Enhanced elements table with optional full_content and search_vector columns and ordering fields
            elements_sql = """
